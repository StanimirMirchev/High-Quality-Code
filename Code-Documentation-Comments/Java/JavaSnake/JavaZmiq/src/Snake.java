...
public class Snake{
    ...
    /**
     *This method sets snake body, color and starting coordinates
     * @param no parameters
     * @return Sets snake body, color and starting coordinates
     */
    ...
    /**
     *This method checks if the snake is in gamefield
     * @param no parameters
     * @return Checks if the snake is in gamefield
     */
